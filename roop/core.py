...
def parse_args() -> None:
    ...
    program.add_argument('--temp-frame-quality', help='image quality used for frame extraction', dest='temp_frame_quality', type=int, default=10, choices=range(101), metavar='[0-100]')
